...
def diagonal():
    ...
    for i in range(4):
        for j in range(3, 6):
            ...
            if board[i][j] == 'A' and board[i + 1][j - 1] == 'A' and board[i + 2][j - 2] == 'A' and \
                    board[i + 3][j - 3] == 'A':
                print(display)
                print("Player A wins!")
                return True

            if board[i][j] == 'B' and board[i + 1][j - 1] == 'B' and board[i + 2][j - 2] == 'B' and \
                    board[i + 3][j - 3] == 'B':
                print(display)
                print("Player B wins!")
                return True
...
if __name__ == '__main__':
    ...
    while not four_in_a_row:  # checks to see of the game is over
